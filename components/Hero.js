...
const Hero = () => {
  const [displayText, setDisplayText] = useState("Web Developer"); // default for SSR
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 overflow-hidden">
      ...
      >
        <a href="https://github.com/Sidd1475" target="_blank">
          <FaGithub className="hover:scale-125 transition-all duration-300" />
        </a>
        <a href="https://www.linkedin.com/in/siddharth-mishra-a5250927a/" target="_blank">
          <FaLinkedin className="hover:scale-125 transition-all duration-300" />
        </a>
        <a href="mailto:siddharth140705@gmail.com" target="_blank">
          <FaEnvelope className="hover:scale-125 transition-all duration-300" />
        </a>
      </motion.div>
