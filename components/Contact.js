...
const Contact = () => {
  const whatsappNumber = '918368865971';
  const defaultMessage = 'Hi Siddharth, I just visited your portfolio and wanted to connect.';
      ...
      <div className='justify-cente text-white relative z-10  p-10 '>
        ...
        <div className=" max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 lg:gap-15 items-start ">
          ...
          <div className='bg-[#1a1a2e] p-8 rounded-xl shadow-2xl'>
            ...
            <form className="space-y-6" action="https://formcarry.com/s/dGFRtrM-RTN" method="POST">
              <div>
              ...
              <button
                type="submit"
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-3 rounded-md hover:opacity-90 transition-all"
              >
